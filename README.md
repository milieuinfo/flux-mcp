...
publish of unpublish); het token komt daar uit de credential `flux-web-componenten/figma_cli`, dezelfde
secret text als in flux-web-components. `ACTION` staat standaard op `geen`, zodat een gewone branch- of PR-build niets
naar Figma stuurt en ook niet naar de credential zoekt.
